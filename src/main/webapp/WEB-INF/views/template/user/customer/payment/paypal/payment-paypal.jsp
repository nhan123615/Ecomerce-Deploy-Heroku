                            ...
                            <div class="ps-block--shipping">
                                ...
                                <div class="ps-block--payment-method">
                                    <ul class="ps-tab-list">
                                        ...
                                        <li><a class="ps-btn ps-btn--sm" href="#momo" style="display: none">MoMo</a>
                                        </li>
                                    </ul>
                                    <div class="ps-tabs">
                                        <div class="ps-tab active" id="visa">
                                            <form class="ps-form--visa"
                                                  action="${pageContext.servletContext.contextPath}/customer/payment/cash"
                                                  method="post">
                                        ...
                                        <div class="ps-tab" id="paypal">
                                            <form action="${pageContext.servletContext.contextPath}/customer/payment/paypal"
                                                  method="post">
                                                <button class="ps-btn">Proceed with Paypal</button>
                                            </form>
                                        </div>
                                        <div class="ps-tab" id="momo">
                                            <form action="${pageContext.servletContext.contextPath}/customer/payment/momo"
                                                  method="post">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                            <div class="ps-block--checkout-order">
                                <div class="ps-block__content">
                                    <figure>
                                        <figcaption><strong>Product</strong><strong class="pr-3 mr-3">Total</strong>
                                        </figcaption>
                                    </figure>
                                    <figure class="ps-block__items"
                                        ...
                                        <c:forEach items="${customerOrder.cartItems}" var="cartItem">
                                            <a>
                                                <strong>${cartItem.product.productName}
                                                    <span>x${cartItem.sellingQuantity}</span> </strong>
                                                <span> <small class="pr-3">$ <fmt:formatNumber type="number"
                                                                                               value="${cartItem.totalPrice}"/></small></span>
                                                    <%--                                                    --%>
                                            </a>
                                        </c:forEach>
                                    </figure>
                                    <figure>
                                        <figcaption><strong><h3>Subtotal</h3></strong><strong><h3 class="pr-3 mr-3">
                                            $<fmt:formatNumber type="number" value="${customerOrder.totalPrice}"/></h3>
                                        </strong></figcaption>
                                    </figure>
                                </div>
                            </div>
